...
const HorizontalScrollCarousel = () => {
  ...
  return (
    <section ref={targetRef} className="relative h-auto md:h-[250vh]">
      <div className="p-0 pl-6 md:pl-12 mx-auto relative z-10 w-full pt-6 md:pt-20" style={{ marginBottom: '2em' }}>
...
const Card = ({ card }: { card: CardType }) => {
  return (
    <div key={card.id} className="group relative h-[500px] w-full max-w-[570px] overflow-hidden md:h-[700px] md:w-[570px] mx-auto">
      <div
        style={{

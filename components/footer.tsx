    ...
    <section className="px-4 sm:px-12 pb-10 py-16 max-w-8xl mx-auto ">
      ...
      >
        <div className="relative z-10 flex flex-col items-center justify-center h-full w-full">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-800 transition-transform group-hover:translate-x-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        <div className="flex flex-col md:flex-row items-center justify-between text-sm text-white">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.6 }} viewport={{ once: true }} className="flex space-x-4 mt-4 md:mt-0">
            {['/linkedin.svg', '/twitter.svg', '/instagram.svg', '/youtube.svg'].map((icon, idx) => (
              <motion.a key={idx} href="#" whileHover={{ scale: 1.15, rotate: 5 }} whileTap={{ scale: 0.95 }} className="hover:text-green-700 transition">
